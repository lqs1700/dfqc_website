<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"E:\wamp64\www\dfqc_website\public/../application/admin\view\privilege\editprivilege.html";i:1522048330;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form action="<?php echo url('editprivilege'); ?>?idd=<?php echo $num['id'];?>" method="post">
